...
function Deforestation() {
  return (
    <div>
      <InfoLayout image = {deforestation} title = "Deforestation" subTitle = "What is Deforestration ?" para ="Climate Change (also known as Global Warming) is the name given to long term changes to temperature on and around the Earth’s surface, which causes long term shifts to weather patterns.
